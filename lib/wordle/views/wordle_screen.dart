...
import 'package:wordle_ng/wordle/data/word_list.dart';
import 'package:wordle_ng/wordle/models/letter_model.dart';
import 'package:wordle_ng/wordle/models/word_model.dart';
import 'package:wordle_ng/wordle/widgets/board.dart';
import 'package:wordle_ng/wordle/widgets/keyboard.dart';
...
class _WordleScreenState extends State<WordleScreen> {
  ...
  final List<Word> _board = List.generate(
    6,
    (index) => Word(letters: List.generate(5, (index) => Letter.empty())),
  );

  final List<List<GlobalKey<FlipCardState>>> _flipCardKeys = List.generate(
    6,
    (index) => List.generate(5, (_) => GlobalKey<FlipCardState>()),
  );
